 ...
 * <b>文件名：</b>PersonHelper.java<br/>
 * <b>版本信息：</b><br/>
 * <b>日期：</b>2016年1月19日-下午2:38:29<br/>
 ...
 * PersonHelper
 *  
 * @author TanDong 2016年1月19日 下午2:38:29
 * 
 * @version 1.0.0
 *
 */
public class PersonHelper {
	...
	public PersonHelper() {
		...
		// 参数2 单线程使用
		// 参数3 等待策略
		ringBuffer = RingBuffer.create(ProducerType.MULTI, PersonEvent.EVENT_FACTORY, BUFFER_SIZE, new BlockingWaitStrategy());
